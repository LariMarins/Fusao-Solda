...
export class ContatoSection extends LitElement {
  static styles = [
    ...
    css`
      ...
      .whatsapp {
        --button-background: color-mix(in srgb, black 20%, #128c7e);
        color: white;
      }
  ...
  mensagemWhatsapp() {
    const mensagem =
      " Olá! Eu olhei o site da Fusão Solda e gostaria de fazer um orçamento";
  ...
  render() {
    ...
    return html`
      ...
      <div>
        <app-botao>
          <a href="mailto:fusaosoldas@yahoo.com.br">
            <feather-icon icon="mail"></feather-icon> Nos envie um email</a
          >
        </app-botao>
